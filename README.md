...
> 🚀 **Новое в версии 1.2.3:** Добавлен редактор изображений с функцией обрезки (crop) - при клике на кнопку редактирования открывается модальное окно!
> ✨ **Добавлено в версии 1.2.2:** Системные иконки папок для корректного отображения!
> 🐛 **Исправлено в версии 1.2.1:** Пути к иконкам, ошибка редактирования фото, улучшена обработка альтернативных путей!

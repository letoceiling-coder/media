# Пошаговая установка и настройка пакета letoceiling-coder/media

> 🚀 **Рекомендуется:** Используйте автоматическую установку `php artisan media:install` вместо ручных шагов ниже!
...
Команда `php artisan media:install` автоматически выполнит все шаги ниже.

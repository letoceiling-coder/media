...
namespace LetoceilingCoder\Media\Models;

use LetoceilingCoder\Media\Models\Traits\Filterable;
use LetoceilingCoder\Media\Models\Traits\HasUserScope;
...
class Folder extends Model
{
     ...
     * Использует динамическую модель пользователя из конфига auth
     * 
     * @return HasOne
     */
